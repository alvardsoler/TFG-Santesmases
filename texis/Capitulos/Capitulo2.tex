...
\begin{itemize}
	\item{Tarjetas RA Nintendo 3DS: Nintendo integra, desde su lanzamiento en 2011, los juegos en RA en su nueva consola. Puedes jugar a distintos minijuegos, utilizando las 6 tarjetas AR Cards. El jugador tiene también la posibilidad de desbloquear nuevos minijuegos.
	A parte de estas aplicaciones preinstaladas en la consola, Nintendo ha ido sacando distintos juegos que también utilizan las AR Cards.}
...
\figura{Tfg/image03.jpg}{width=.5\textwidth}{fig:profesorSantesmases}
...
\figura{Tfg/image02.jpg}{width=.5\textwidth}{fig:inaveders0}
...
\figura{Tfg/image07.jpg}{width=.5\textwidth}{fig:cronautas}
	{Cronautas}
...
\figura{Tfg/image01.png}{width=.5\textwidth}{fig:racma}
