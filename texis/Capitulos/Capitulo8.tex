...
La tabla \ref{cap8:tab:cuestionariosus} muestra las preguntas finales, con las respuestas necesarias para sacar el 100\% de la puntuación.
...
En la tabla \ref{cap8:tab:promediosprimera} mostramos el promedio de los resultados obtenidos de los cuestionarios realizados en este primer análisis. Es decir, una nota que representa la usabilidad de los minijuegos. 
...
En cambio, la puntuación de los otros dos juegos se encuentran en el caso opuesto. No llegan a suspender en usabilidad reciben una puntuación bastante baja. límite para que la usabilidad del juego no sea buena, se aproximan demasiado. 
...
\subsection{Propuesta de soluciones}
...
En cualquier caso, la experiencia del usuario en general ha sido buena debido a que sus comentarios al completar la yincana eran positivos y la mayoría querían repetir la experiencia.
